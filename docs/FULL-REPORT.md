# چارت تولد — مستند کامل فنی (صفر تا صد، با کد)

> **هدف این سند:** یک فایل مستقل و جامع که یک هوش مصنوعی دیگر بدون دسترسی به مخزن، کل پروژه را بفهمد، تحلیل کند و ادامه بدهد.
> **تاریخ تولید:** ۲۲ مرداد ۱۴۰۵ (۱۳ اوت ۲۰۲۶) · **آخرین کامیت:** eab4725 2026-08-13 فیکس باگ خرید: metadata.mobile خالی زرینپال رو رد میکرد (502) + جریان خرید بدون چارت → ساخت چارت → بازگشت + منوی پایین: مقالات→پلنها
> **حجم:** 47 فایل پایتون + 25 قالب HTML · 45 کامیت · لایو: https://chart.negar.io
...
| GET /chart/<built-in function id> · /api/charts/<built-in function id> | نمایش چارت + پیش‌نمایش رایگان |
...
### `app/astrology/golden_data.py` (101 lines)
...
### `app/chat/retrieval.py` (56 lines)
...
### `app/payment/orders.py` (121 lines)
...
### `app/payment/zarinpal.py` (81 lines)
...
### `app/report/generator.py` (106 lines)
...
### `app/report/preview.py` (79 lines)
...
### `app/report/prompt_builder.py` (170 lines)
...
### `app/report/worker.py` (170 lines)
...
### `app/templates/account.html` (80 lines)
...
### `app/templates/admin.html` (166 lines)
...
### `app/templates/article.html` (33 lines)
...
### `app/templates/articles_index.html` (26 lines)
...
### `app/templates/base.html` (286 lines)
  ...
  <div class="wrap">
    <header class="appbar">
      <div class="appbar-inner">
        <a href="/" class="brand" aria-label="چارت تولد — صفحه اصلی">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01z"/></svg>
          <span>چارت تولد</span>
        </a>
        <nav class="appnav" aria-label="ناوبری اصلی">
          <a href="/" class="nav-item">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2h-4v-7h-6v7H5a2 2 0 0 1-2-2z"/></svg>
            خانه
          </a>
          <a href="/birth-form" class="nav-item">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="M12 8v4l3 3"/></svg>
            چارت رایگان
          </a>
          <a href="/articles" class="nav-item">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20V2H6.5A2.5 2.5 0 0 0 4 4.5v15z"/><path d="M4 19.5A2.5 2.5 0 0 0 6.5 22H20v-5"/></svg>
            مقالات
          </a>
          <a href="/guide" class="nav-item">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="M16.24 7.76l-2.12 6.36-6.36 2.12 2.12-6.36z"/></svg>
            راهنما
          </a>
    ...
    <footer class="footer">
      ...
      <div class="footer-bar">
        <div class="disc">🔭 چارت تولد — نقشه‌ی آسمان تو. محتوای این سایت صرفاً برای سرگرمی و خودشناسی است و مبنای تصمیم‌های مهم زندگی نیست.</div>
        <div>© ۱۴۰۵ چارت تولد · پرداخت امن زرین‌پال</div>
      </div>
    </footer>
  </div>
  <nav class="bottomnav" aria-label="ناوبری پایین">
    ...
    <a href="/birth-form" class="bn-fab" aria-label="چارت رایگان">
      <span class="fab-circle">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01z"/></svg>
      </span>
      <span>چارت رایگان</span>
    </a>
    <a href="/guide" class="bn-item">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="M16.24 7.76l-2.12 6.36-6.36 2.12 2.12-6.36z"/></svg>
      راهنما
    </a>
    <a href="/account" class="bn-item">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
      حساب من
    </a>
  </nav>
...
### `app/templates/chart.html` (152 lines)
...
### `app/templates/chat.html` (64 lines)
...
<div style="max-width:640px; margin:0 auto; padding-top:36px;">
  ...
  <div class="glass" style="margin-top:16px; padding:26px; line-height:2;">
    ...
    <ul style="margin:14px 0 0 18px;">
      <li>گزارش‌ها یک ابزار تأمل و خودشناسی هستند و <b>پیش‌بینی‌ی آینده یا مشاوره‌ی حرفه‌ای</b> (پزشکی، روان‌شناسی، حقوقی، مالی) محسوب نمی‌شوند.</li>
...
### `app/templates/faq.html` (22 lines)
...
### `app/templates/form.html` (128 lines)
...
### `app/templates/payment_result.html` (30 lines)
...
### `app/templates/plans.html` (73 lines)
...
### `app/templates/privacy.html` (19 lines)
...
### `app/templates/rectify.html` (118 lines)
...
### `app/templates/seo_index.html` (51 lines)
...
### `app/templates/seo_page.html` (28 lines)
...
### `app/templates/synastry.html` (143 lines)
...
<div style="max-width:640px; margin:0 auto; padding-top:36px;">
  ...
  <div class="glass" style="margin-top:16px; padding:26px; line-height:2;">
    <p>با استفاده از خدمات «چارت تولد» این قوانین را می‌پذیری:</p>
    <ul style="margin:14px 0 0 18px;">
...
66 passed, 3 skipped, 1 warning in 0.59s
```

---

## ۱۱) تاریخچه گیت (کامل — 45 کامیت)

```
eab4725 2026-08-13 فیکس باگ خرید: metadata.mobile خالی زرینپال رو رد میکرد (502) + جریان خرید بدون چارت → ساخت چارت → بازگشت + منوی پایین: مقالات→پلنها
dfcd6b9 2026-08-13 UI/UX overhaul: رفع کنتراست حالت روشن (#3b2f80/#444) → تم تیره، bottom-nav اپلیکیشنی + FAB، spidering شعاعی سیارات SVG، ۴ صفحه قوانین/استرداد/سلب مسئولیت/تماس، فوتر ۴ ستونه + نوار سلب مسئولیت
a18c342 2026-08-13 اسکریپت ساخت PDF فارسی گزارش ساده (weasyprint) + آپدیت PLAIN-REPORT
2f22b4c 2026-08-13 UI موبایل به سبک اپلیکیشن: اپبار شیشه‌ای چسبان با آیکون SVG + افکت درخشش دوره‌ای + شفق متحرک ۳ رنگی + شیشه روشن‌تر (blur 26px saturate 170%) + هدف لمسی 46px + active طلایی
c280151 2026-08-13 بُعد بک‌اند (اجرای مجدد V4 Pro): 7 یافته — فیکس P0 sidereal state global (tropical+ayanamsa دستی، golden پاس)، _EVENT_RULES rectify اعمال شد، سقف ۳ رویداد، EPHE_PATH از env، validate jalali، فاصله دایره‌ای SVG، گارد big_three؛ اسناد به‌روز شد
13ee3c0 2026-08-13 noindex صفحه لاگین ادمین
23b75bd 2026-08-13 راستیآزمایی نهایی ممیزی: ایندکسهای مرکب واقعا روی DB (rollback شده بودند) + noindex chart/admin با block robots
31bb16a 2026-08-13 ممیزی بیرونی — تمام P0: OTP fail-closed+503، AUTH_SECRET/ADMIN_PIN/ADMIN_SECRET/DATABASE_URL اجباری در prod، auth O(1) با cookie امضاشده، وبهوک TG fail-closed + Bale secret-URL، ساعت نامعلوم (engine+UI+prompt+widget)، noindex، UNIQUE botstates، indexها، Redis pool مشترک، throttle ادمین، /tmp cleanup، پاسخ مستند EXTERNAL-AUDIT-RESPONSE
333b7d8 2026-08-13 زیرساخت (از بررسی بیرونی): uvicorn --proxy-headers --forwarded-allow-ips=127.0.0.1 — IP واقعی کلاینت پشت nginx (rate limit ها قبلا کلیدی مشترک 127.0.0.1 داشتند)
ca5fa5e 2026-08-13 ۳۰ مقاله SEO کامل (۶۱۴ کلمه میانگین، ۷ سکشن) + بازتولید ۳ مقاله خراب + توقف کرون
8b5f7b6 2026-08-13 SEO: تایتل و متا اختصاصی صفحات سیناستری/رفتیفای/اکانت
ffea368 2026-08-13 PLAIN-REPORT کامل: بخش 7 نتایج تحلیل (فیکس‌ها + ادعاهای ردشده + پیشنهادهای بعدی)
36c055a 2026-08-13 بسته کامل docs/audit (15 سند: تحلیل + اکشن پلن + صفر تا صد) + ZIP نهایی
90ac0b6 2026-08-13 فیکس بنر مقالات: SVG ریسپانسیو (width:100%) + نماد با text-presentation (نه ایموجی رنگی) — تأیید پیکسلی رندر متن
8db3284 2026-08-13 تصاویر مقالات: بنر SVG برند-محور (رایگان، بدون LLM) + کرون پرکننده مقالات (guard+lock+atomic save) + retry/پارس مقاوم
fab7cbc 2026-08-13 فیکس حیاتی (پیداشده با تست مرورگر واقعی): x-data روی div والد صفحه چارت — پیش‌نمایش رایگان (بینش‌های AI) و دکمه‌های تولید/دانلود/اشتراک قبلاً بیرون از اسکوپ Alpine بودند و کار نمی‌کردند؛ حالا 5 بینش رندر می‌شود
c5d69b6 2026-08-13 فیکس های تحلیل DeepSeek (تأییدشده): P0: کالبک idempotent + enqueue بعد از commit + گیت مالکیت PDF/DOCX/صوت + چت فقط gold/monthly + وب‌هوک dedupe/try-except؛ P1: donut عناصر درست شد + rate limit rectify/synastry/share/chat + سانسور ورودی پرامپت
e44497c 2026-08-13 تحلیل کامل DeepSeek V4 Pro (10 بعد + ترکیب) + ACTION-PLAN راستیآزماییشده در کد (P0: کالبک/مالکیت/چت-gold/وبهوک + P1/P2)
b23c1f1 2026-08-13 سند صفر-تا-صد به زبان ساده (PLAIN-REPORT) + sitemap داینامیک مقالات + اسکریپت تولید مقالات SEO
40c1c80 2026-08-13 فیکس: سینتکس معتبر Jinja برای help-tip (with→endwith) — فرم با 4 دکمه راهنما لایو
b511159 2026-08-13 صفحات محتوا: راهنما/درباره ما/FAQ + بخش مقالات (articles.json) + دکمه های راهنما (؟) روی فیلدهای فرم + فوتر + sitemap — آماده برای محتوای V4 Pro
587125e 2026-08-12 max_tokens 8192 برای بخش های عمیق (رفع truncate QA) + build_chat_router با go-flash برای چت سریع
e5d284d 2026-08-12 LLM: GoProvider (opencode.ai Go — deepseek-v4-pro/flash، thinking disabled + UA مرورگر برای Cloudflare) — اولویت go→gemini→avalai؛ هزینه اشتراک ثابت $10/ماه
da0c7f4 2026-08-12 بستن آخرین شکاف ها: بازتولید گزارش از ادمین (regenerate + enqueue) + عمق بخش ها 700-1000 کلمه و فصل اسلامی 600-900 (حجم PDF طبق پلن §10.3)
1b99649 2026-08-12 آخرین مورد باز پلن: مدیریت پرامپت در ادمین (prompt_versions — نسخه بندی + اورراید در worker) — 66 تست پاس
40f904d 2026-08-12 چکلیست بهروز: 8 مورد فاز 10 بسته شد — 1 مورد باز در کد (ادمین پرامپت) + 5 نیازمند کاربر
deb04aa 2026-08-12 گزارش فاز 10 (v0.7.1)
48de0dc 2026-08-12 فاز 10 تکمیل: تفکیک پلن ها (basic5/full13/gold+اسلامی+ترانزیت)، فصل فرهنگی-اسلامی، پیش نمایش رایگان، سیناستری پولی 499k، اشتراک ماهانه 399k، ترانزیت هفتگی+نمودار سالانه SVG، ادمین کامل (پلن/کاربر/لاگ/هزینه AI)، PWA+CI
cbd227f 2026-08-12 فیکس فرایند: چک لیست کامل پلن v3.0 (منبع حقیقت بعد از compaction) — هر ادعای تمام-شد باید با این فایل + پلن تطبیق شود
9fb84a7 2026-08-12 الحاقیه R2 به گزارش فاز
8f70e9a 2026-08-12 R2: آپلود PDF گزارش ها به Cloudflare R2 (bucket hermes-voice-clone، کلید chart-reports/) + دانلود با 302 presigned — اتصال از کلیدهای رمزنگاری vc
8ca436d 2026-08-12 گزارش فاز v0.7.0
d025ba9 2026-08-12 فاز 5-9 تکمیل: OTP+حساب کاربری، کوپن+ریفاند، SVG ویجت ها، Word/ودیک/صوت/BirthTimeFinder، سیناستری، صفحات SEO، referral، اشتراک ترانزیت روزانه، امنیت CSRF/rate-limit/audit
140e8da 2026-08-12 فیکس فونت: @font-face وزیرمتن در وب (قبلا فقط PDF بود) + سینک فونت به nginx static
d904c6d 2026-08-12 SEO: canonical per-page
f57d430 2026-08-12 هاردنینگ: auth ادمین (PIN) + گیت PDF + باندل لوکال Alpine/HTMX + CSP/headers nginx + فیکس سرریز موبایل (حباب) + Big Three تک ستونه + اسموک E2E تعاملی
1dce2f3 2026-08-12 Deployment: chart.negar.io live + nginx/SSL + ربات توکن ها + webhook ست + .env/load_dotenv + RUNBOOK
e982c7f 2026-08-12 فاز 6-9 تکمیل: LLMRun metering + systemd worker + E2E کامل 13/13 + docs/RUNBOOK + تست DB جدا
1affa7a 2026-08-12 v0.6.0 — فاز 6-9: ربات های تلگرام/بله + SEO + کارت اشتراک + ترانزیت + 15 کلید Gemini جدید + تست DB جدا
f7136da 2026-08-12 v0.5.0 — فاز 5: AI Chat retrieval + دشبورد ادمین + دانلود + E2E کارگر ARQ تأیید شد
5b20df6 2026-08-12 v0.4.0 — فاز 4 تجاری: زرین پال سندباکس + پلن ها + سفارشات + تولید خودکار گزارش
a261111 2026-08-12 فاز 3 کامل: 13/13 سکشن + PDF 27 صفحه + QA نهایی
96160d5 2026-08-12 فاز 3: json_mode اجباری + سهمیه روزانه 20/کلید + قوانین جایگزین + QA مقاوم
8b71993 2026-08-12 v0.2.0 — فاز 2 (محصول رایگان): فرم 5 مرحله + چارت + Big Three
0666598 2026-08-12 v0.1.0 — فاز 0 (زیرساخت) + فاز 1 (موتور نجومی)
```
